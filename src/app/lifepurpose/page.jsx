...
import { Header, Interpretation } from "../components";
        ...
        <div className="flex-col px-2 sm:px-20 w-full sm:w-10/12">
          ...
          <div className="mt-10 mb-10 flex justify-center items-center text-2xl sm:mx-10">
            <input
              ...
              className="px-4 py-2 outline-none text-black rounded-l-full w-full sm:w-10/12 text-sm sm:text-xl"
            />
            <button
              onClick={analyzeName}
              className="px-6 py-2 bg-gray-400 rounded-r-full hover:bg-gray-500 text-sm sm:text-xl"
            >
              Go
            </button>
          </div>
